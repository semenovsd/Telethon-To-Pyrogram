...
TG_USERNAME_RECIPIENT: str = input("Please insert telegram username recipient fro test message: ")


async def main():
    async with TelegramClient(TELETHON_SESSION_FILE, api_id=API_ID, api_hash=API_HASH) as client:
